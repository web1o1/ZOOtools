...
initOranizerTitle:function(){var b=this,c=b.element.find(".zlfield .row[data-id=_layout] select"),a=b.element.find(".name");c.on("loaded.zlfield",function(){var c=b.element.find(".zlfield .row[data-id=name] input");c.on("keyup zlinit",function(){a.html(c.val())}).trigger("zlinit")}).trigger("loaded.zlfield")}});b.fn[c.prototype.name]=function(){var e=arguments,d=e[0]?e[0]:null;return this.each(function(){var a=b(this);if(c.prototype[d]&&a.data(c.prototype.name)&&"initialize"!=d)a.data(c.prototype.name)[d].apply(a.data(c.prototype.name),
Array.prototype.slice.call(e,1));else if(!d||b.isPlainObject(d)){var f=new c;c.prototype.initialize&&f.initialize.apply(f,b.merge([a],e));a.data(c.prototype.name,f)}else b.error("Method "+d+" does not exist on jQuery."+c.name)})}})(jQuery);