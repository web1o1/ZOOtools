...
(function ($) {
	...
	Plugin.prototype = $.extend(Plugin.prototype, {
		...
		initialize: function(element, options) {
			...
			var separator = $('<div class="zl-separator zl-bootstrap" />')
			...
			{
				var	nextSeparator = separator.nextAll('.zl-separator').first(),
